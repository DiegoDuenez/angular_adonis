...
export class UsuariosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(!this.idParam){
      this.authService.usuarios().subscribe((data: any) => {
        ...
        /*this.user = {
          nombre: data.usuarios.nombre?.value,
      ...
      this.authService.usuarios(this.idParam).subscribe((data: any) => {
  ...
  selectChangeHandler (event: any) {
    ...
    this.authService.usuarios(this.selectedId).subscribe((data: any) => {
