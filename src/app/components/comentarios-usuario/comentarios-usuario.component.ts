...
export class ComentariosUsuarioComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.idParam){
      ...
      this.authService.comentariosUsuario(this.idParam).subscribe((data: any) => {
        ...
        console.log(this.comentarios)
          ...
          this.http.get('http://127.0.0.1:3333/usuarios').subscribe((data: any) => {
      ...
      this.authService.comentarios().subscribe((data: any) => {
  ...
  selectChangeHandler (event: any) {
    ...
    this.authService.comentariosUsuario(this.selectedId).subscribe((data: any) => {
